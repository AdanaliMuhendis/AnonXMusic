...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AdanaliMuhendis/AnonXMusic",
)
...
TG_AUDIO_FILESIZE_LIMIT = int(getenv("TG_AUDIO_FILESIZE_LIMIT", 10485760))
TG_VIDEO_FILESIZE_LIMIT = int(getenv("TG_VIDEO_FILESIZE_LIMIT", 107374180))
