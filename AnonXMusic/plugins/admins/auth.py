...
@app.on_message(filters.command("auth", "yt") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(filters.command("unauth", "unyt") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(
    filters.command(["authlist", "authusers", "ytlist"]) & filters.group & ~BANNED_USERS
)
@language
