...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "UpVote":
        ...
        if get_upvotes >= upvote:
            ...
            try:
                ...
                return await CallbackQuery.edit_message_text(f"𝙷𝚊𝚝𝚊.")
            try:
    ...
    if command == "Pause" or command == "Dur" or command == "Duraklat" or command == "Bekle":
    ...
    elif command == "Stop" or command == "Bitir" or command == "Son" or command == "End":
        await CallbackQuery.answer()
    ...
    elif command == "Skip" or command == "Atla" or command == "Replay":
