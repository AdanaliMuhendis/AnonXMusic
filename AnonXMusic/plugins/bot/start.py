...
@app.on_message(filters.command(["start", "baslat", "basla"]) & filters.private & ~BANNED_USERS)
@LanguageStart
...
@app.on_message(filters.command(["start", "baslat", "basla"]) & filters.group & ~BANNED_USERS)
@LanguageStart
