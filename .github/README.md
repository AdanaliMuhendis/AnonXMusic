...
- Get your [Necessary Variables](https://github.com/AdanaliMuhendis/AnonXMusic/blob/master/sample.env)
...
`git clone https://github.com/AdanaliMuhendis/AnonXMusic && cd AnonXMusic`
